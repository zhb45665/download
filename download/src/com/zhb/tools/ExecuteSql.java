...
//			String sql = "select a.phone,a.area,a.quesstion,b.initpath,b.recpath from `"+tableName+"` a,zx_rec_info b,call_session c where a.id=c.id and c.bscallid = b.bscallid" ;
//			String sql = "select a.phone,a.area,a.quesstion,b.initpath,b.recpath from `"+tableName+"` a,zx_rec_info b,call_session c where a.phone=c.call_to and c.bscallid = b.bscallid" ;
			String sql = "select id,call_to,bscallid,initpath,recpath from "+tableName;
